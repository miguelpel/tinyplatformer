...
const ANIMATION = preload("res://game/objects/scenes/GreenShirt/children/AnimatedSprite.tscn")
const KINEMATIC_BODY = preload("res://game/objects/scenes/GreenShirt/children/KinematicBody2D.tscn")
const TEXTURE_RECT = preload("res://game/objects/scenes/GreenShirt/children/TextureRect.tscn")
