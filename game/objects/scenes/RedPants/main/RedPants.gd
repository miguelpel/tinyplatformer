...
const ANIMATION = preload("res://game/objects/scenes/RedPants/children/AnimatedSprite.tscn")
const KINEMATIC_BODY = preload("res://game/objects/scenes/RedPants/children/KinematicBody2D.tscn")
const TEXTURE_RECT = preload("res://game/objects/scenes/RedPants/children/TextureRect.tscn")
