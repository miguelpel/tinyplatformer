...
const CATEGORY = "hat"
const ANIMATION = preload("res://game/objects/scenes/RedBeret/children/AnimatedSprite.tscn")
const KINEMATIC_BODY = preload("res://game/objects/scenes/RedBeret/children/KinematicBody2D.tscn")
const TEXTURE_RECT = preload("res://game/objects/scenes/RedBeret/children/TextureRect.tscn")
const VALUE = 3
